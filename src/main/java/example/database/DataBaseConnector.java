...
public class DataBaseConnector {
        ...
        private static final String DB_SETUP_FILE_NAME = "dbsetup.sql";
        public void DatabaseConnector() throws DataBaseConnectionException {
            try {
                this.setProperties();
            } catch (IOException e) {
            ...
            if (connection == null) {
                try {
                    ...
                    throw new DataBaseConnectionException("Error creating properties", e);
                }
            }
        }
